...
# [VOICE-DEBUG-CAPTURE] runtime-injected dev gate; see inject.js + compose.yaml
ENV VITE_STOAT_DEBUG_CAPTURE=__VITE_STOAT_DEBUG_CAPTURE__
ENV BASE_PATH=/
